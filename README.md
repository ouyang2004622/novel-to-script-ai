...
PR 1 已完成 Node / Next.js 项目初始化，包括基础首页、项目目录、环境变量示例和提交计划文档。

当前阶段在 PR 1 的基础上优化首页展示和项目文档：

- 首页移除红色训练营标签，改为深色科技感视觉。
- 增加功能入口占位按钮，方便后续接入真实功能。
- 更新 PR 开发计划，让后续阶段可以根据实现进度灵活调整。
- 更新 README，说明当前阶段的改动范围和本地运行方式。

当前阶段不包含 AI 调用、YAML 生成、剧本预览、小说解析等业务功能。
...
当前阶段使用 AI 工具辅助整理文档表述、生成首页样式草稿和调试建议。页面结构、代码整合、本地运行检查和最终提交由本人完成。
